...
namespace Xim.AppApi.Controllers
{
    ...
    public class DonviController : BaseController
    {
        ...
        public DonviController(IServiceProvider serviceProvider) : base(serviceProvider)
        {
            _service = serviceProvider.GetService<IDonviService>();
        }
        /// <summary>
        /// Admin: QL danh sách đơn vị
        /// </summary>
        ...
        /// <summary>
        /// Admin: Thêm mới đơn vị
        /// </summary>
        /// <param name="model"></param>
        /// <returns></returns>
        [HttpPost]
        public async Task<IActionResult> InsertAsync([FromBody] DonviDtoCreate model)
        {
        ...
        /// <summary>
        /// Admin: Lưu thông tin sửa đv
        /// </summary>
        /// <param name="id"></param>
        /// <param name="model"></param>
        /// <returns></returns>
        [HttpPut("{id}")]
        public async Task<IActionResult> UpdateAsync(Guid id, [FromBody] DonviDtoUpdate model)
        {
            model.id = id;
